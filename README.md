...
# Online Gadget Hub(E-Commerce Website)
...
Step 4: In Select an App Section: select Other (custom name) => enter "Gadget Hub" => Generate
...
Step 2: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/TechExplorerSam/Advanced-Java-Project-Multi-Vendor-E-commerce.git```> Select master Branch > Next > Next > Finish.
...
Step 8: Check Running The Site At  [http://localhost:8080/GadgetHub/](http://localhost:8080/GadgetHub/)

Step 9:  [To Change the Port, if getting error like 'port already in use'] Open The Server Tab > Double Click On Tomcat Server > Ports > Change The Port Number For Http/1.1 To 8083 > Close And Save. Now Start and you can access the project on [http://localhost:8083/GadgetHub/](http://localhost:8083/GadgetHub/)
