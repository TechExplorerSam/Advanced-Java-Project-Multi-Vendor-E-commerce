package com.sampath.service.impl;
...
import com.GadgeHub.beans.DemandBean;
import com.GadgeHub.beans.ProductBean;
import com.sampath.service.ProductService;
import com.sampath.utility.DBUtil;
import com.sampath.utility.IDUtil;
import com.sampath.utility.MailMessage;
...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductBean> getAllProductsByType(String type) {
		...
		try {
			ps = con.prepareStatement("SELECT * FROM `GadgetHub`.product where lower(ptype) like ?;");
			ps.setString(1, "%" + type + "%");
			rs = ps.executeQuery();
	...
	public List<ProductBean> searchAllProducts(String search) {
		...
		try {
			ps = con.prepareStatement(
					"SELECT * FROM `GadgetHub`.product where lower(ptype) like ? or lower(pname) like ? or lower(pinfo) like ?");
			search = "%" + search + "%";
