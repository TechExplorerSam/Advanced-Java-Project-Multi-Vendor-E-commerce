...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "mathasampath2022@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "Thanks for singing up with Gadget Hub.<br>"
					...
					+ "<span class='greenText'>Gadeget500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
