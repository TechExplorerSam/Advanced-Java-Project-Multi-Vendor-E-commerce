...
import com.sampath.service.impl.CartServiceImpl;
import com.sampath.service.impl.DemandServiceImpl;
import com.sampath.service.impl.ProductServiceImpl;
...
public class AddtoCart extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (pQty == cartQty) {
			...
			System.out.println("<script>document.getElementById('message').innerHTML='" + status + "'</script>");
